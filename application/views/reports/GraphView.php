<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Summary by date range</h1>
    ...
    <form class="form-inline" action="#" autocomplete="off" method="POST">
        ...
        <button type="button" class="btn btn-warning" onclick="getSummary();"><i class="fas fa-sync-alt"></i> Process</button>
    </form>
...
<script>
    ...
    function getSummary() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= site_url('ReportController/FetchSummaryReport') ?>",
            data: formData,
            cache: false,
            beforeSend: function() {
                blockUI('Please wait a moment...');
            }
        }).done(function(data) {
            unblockUI();
