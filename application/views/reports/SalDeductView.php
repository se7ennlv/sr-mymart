<section class="mb-1">
    <h5 class="m-0 font-weight-bold text-primary pull-left"><i class="fa fa-th-list"></i> <strong>Salary Deduction List</strong></h5>
</section>
        ...
        <div class="table-responsive" style="max-height: 58vh">
                ...
                <form class="form-inline" action="#" autocomplete="off" method="POST">
                    <div class="input-group ml-1 mr-1">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Payroll Period:</span>
                        </div>
            ...
            <table class="table table-bordered table-sm" id="dataTable" data-toolbar="#toolbar" data-search="true" data-show-toggle="true" data-show-fullscreen="true" data-show-columns="true" data-show-columns-toggle-all="true" data-show-export="true" data-minimum-count-columns="2" data-show-pagination-switch="true" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-show-footer="true">
                <thead>
                    ...
                    <tr>
                        <th colspan="5">Salary Deduction List</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th data-field="TotalCredit" class="text-nowrap text-center" data-formatter="money" data-footer-formatter="summary">Deducted Amount</th>
                    </tr>
                </thead>
            </table>
        </div>
...
<script>
    ...
    function initData(fDate, tDate) {
        $.ajax({
            type: 'GET',
            url: "<?= site_url('ReportController/FetchAllSalDeduct') ?>/" + fDate + '/' + tDate,
            dataType: 'JSON',
            beforeSend: function() {
                blockUI('Loading...');
            }
    ...
    function initTable(data) {
        $table.bootstrapTable('destroy').bootstrapTable({
            ...
            exportDataType: 'all',
            exportOptions: {
                fileName: 'Salary-Deduction-Reports'
            }
        })
    }
</script>